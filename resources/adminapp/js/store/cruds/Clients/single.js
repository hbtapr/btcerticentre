...
const actions = {
  ...
  setSocialNumber({ commit }, value) {
    commit('setSocialNumber', value)
  },
  setClientName({ commit }, value) {
...
const mutations = {
  ...
  setSocialNumber(state, value) {
    state.entry.social_number = value
  },
  setClientName(state, value) {
    state.entry.client_name = value
  },
