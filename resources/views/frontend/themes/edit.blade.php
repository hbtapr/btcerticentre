    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.themes.update", [$theme->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="micro_theme">{{ trans('cruds.theme.fields.micro_theme') }}</label>
                            <input class="form-control" type="text" name="micro_theme" id="micro_theme" value="{{ old('micro_theme', $theme->micro_theme) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="macro_theme" id="macro_theme" value="{{ old('macro_theme', $theme->macro_theme) }}">
