        ...
        <div class="col-md-12">
            @can('alternative_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.alternatives.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $alternative->id }}">
                                        ...
                                        <td>
                                            @can('alternative_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.alternatives.show', $alternative->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('alternative_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.alternatives.edit', $alternative->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('alternative_delete')
                                                <form action="{{ route('frontend.alternatives.destroy', $alternative->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('alternative_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.alternatives.massDestroy') }}",
