                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('theme_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.themes.index') }}">
                                            {{ trans('cruds.theme.title') }}
                                        </a>
                                    @endcan
                                    @can('attempt_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.attempts.index') }}">
                                            {{ trans('cruds.attempt.title') }}
                                        </a>
                                    @endcan
                                    @can('demo_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.demos.index') }}">
                                            {{ trans('cruds.demo.title') }}
                                        </a>
                                    @endcan
                                    @can('alternative_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.alternatives.index') }}">
                                            {{ trans('cruds.alternative.title') }}
                                        </a>
                                    @endcan
