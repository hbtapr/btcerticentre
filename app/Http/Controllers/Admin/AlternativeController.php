...
class AlternativeController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.alternatives.create', compact('questions', 'themes', 'types', 'difficulties'));
    }
    ...
    public function edit(Alternative $alternative)
    {
        ...
        return view('admin.alternatives.edit', compact('questions', 'themes', 'types', 'difficulties', 'alternative'));
    }
