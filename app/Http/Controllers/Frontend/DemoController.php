...
class DemoController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.demos.index', compact('demos'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.demos.create', compact('partner_demos'));
    }
    ...
    public function store(StoreDemoRequest $request)
    {
        ...
        return redirect()->route('frontend.demos.index');
    }
    ...
    public function edit(Demo $demo)
    {
        ...
        return view('frontend.demos.edit', compact('partner_demos', 'demo'));
    }
    ...
    public function show(Demo $demo)
    {
        ...
        return view('frontend.demos.show', compact('demo'));
    }
