...
class AttemptsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.attempts.create', compact('certificates'));
    }
    ...
    public function store(StoreAttemptRequest $request)
    {
        ...
        return redirect()->route('frontend.attempts.index');
    }
    ...
    public function edit(Attempt $attempt)
    {
        ...
        return view('frontend.attempts.edit', compact('certificates', 'attempt'));
    }
    ...
    public function show(Attempt $attempt)
    {
        ...
        return view('frontend.attempts.show', compact('attempt'));
    }
